            ...
            <div className="flex flex-col gap-3 border-b border-slate-200 pb-4 sm:flex-row sm:items-start sm:justify-between">
              <div className="grid gap-2">
                ...
                <div className="grid gap-2 text-sm mt-2">
                  ...
                  <p className="mt-4">
                    <strong className="text-slate-700 text-base">Cliente:</strong>{" "} {capitalize(order.customer_name)}
                  </p>

                  <p>
                    <strong className="text-slate-700 text-base">Telefone:</strong>{" "}
                          {formatPhone(order.customer_phone)}
                  </p>

  <p>
    <strong className="text-slate-700 text-base">Forma de pagamento:</strong>{" "}
    {capitalize(order.payment_method)}
  </p>

  {order.delivery_type === "delivery" && (
    <p>
      <strong className="text-slate-700 text-base">Endereço:</strong>{" "}
      {capitalize(order.delivery_address)}
    </p>
  )}

                  <p>
                    <strong className="text-slate-700 text-base">Restaurante:</strong>{" "} {order.restaurant_name}
                  </p>
            ...
            <div>
              <h2 className="text-slate-700 font-bold text-base">Itens do pedido:</h2>
            ...
            ">
              ...
              <div className="space-y-4">
                {history.map((entry, index) => (
                  <div key={`${entry.status}-${index}`} className="flex items-center space-y-1 justify-between"> 
